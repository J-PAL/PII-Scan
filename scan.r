...
#path <- "~/Dropbox (MIT)/_data_verification_pd (1)/30/AEJApp2008-0221_data/data/original_data"
#path <- "~/Dropbox (MIT)/_data_verification_pd (1)/completed/audits_rosa/27/27_angrist_et_al_data/data"
path <-"SET PATH"
